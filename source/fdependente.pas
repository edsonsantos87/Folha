...
begin
  ...
  CriarColuna(tv, 'NOME', 'Nome do Dependente', 280, StyloHeader);
  CriarColuna(tv, 'SEXO', 'Sexo', 40, StyloHeader);
  CriarColuna(tv, 'NASCIMENTO', 'Nascimento', 80, StyloHeader);
  CriarColuna(tv, 'TIPO', 'Tipo(s)', 90, StyloHeader);
  CriarColuna(tv, 'INVALIDO_X', 'Inv.', 40, StyloHeader);
...
begin
  try
    Result := StrToIntDef(cdFuncionario.FieldByName('IDFUNCIONARIO').AsString, 0);
  except
    Result := 0;
  end;
end;
