...
begin
  ...
  mtBairro.FieldDefs.Add('BAIRRO', ftString, 30);
...
begin
  ...
  kSQLSelectFrom( Bairro, '"public"."BAIRRO"');
  kSQLSelectFrom( Cidade, '"public"."CIDADE"');
