...
uses
  ...
  {$ENDIF}
  Variants, fcadastro, DB, DBClient, cxStyles, cxGraphics, cxControls,
...
type
  TFrmEmpresa = class(TFrmCadastro)
    ...
    dbCEP: TDBEdit;
    tvIDEMPRESA: TcxGridDBColumn;
    tvNOME: TcxGridDBColumn;
    tvAPELIDO: TcxGridDBColumn;
    tvCPF_CGC: TcxGridDBColumn;
    ...
    Label3: TLabel;
    TabFolha: TTabSheet;
    TabEscrita: TTabSheet;
    TabContabilidade: TTabSheet;
    ...
    procedure tvCPF_CGCGetDisplayText(Sender: TcxCustomGridTableItem;
...
begin
  ...
  PageControl2.ActivePage := TabGeral;
end;
...
procedure TFrmEmpresa.tvCPF_CGCGetDisplayText(
